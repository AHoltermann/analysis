...
- Likewise, the Sector and IB frequencies are incremented by the fraction of their towers that register a hit. 
- A histogram is filled with the total number of hits for each tower, IB, and Sector throughout the total number of events
